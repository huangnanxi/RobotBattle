...
import com.kxd.code.competition.robot.fight.av.AVFightRobot;
import com.kxd.code.competition.robot.fight.fuck.MiaoRobot;
import com.kxd.code.competition.robot.fight.mvp.MvpFightRobot;
...
public class RobotBattleMain {
    ...
    private final static void fightBattle(String[] args) {
        ...
        AbstractElementsData fightElementData = new FightElementsData();
        {
            ...
            robots.add(new StormBattleFightRobot());
            robots.add(new Sign47FightRobot());
            robots.add(new IncredibleHulkRobot());
            robots.add(new LittleBaby());
            robots.add(new MiaoRobot());
            robots.add(new AVFightRobot());
            robots.add(new BaoLeiFightRobot());
            robots.add(new WaliFightRobot4());
            robots.add(new MvpFightRobot());
            robots.add(new FightForFree());
            robots.add(new BigHuFaFightRobot());
            robots.add(new KingOfFightRobot3());
            robots.add(new BoomFightRobot());
            robots.add(new NewNewVanGosh());
            robots.add(new OldBoyFightRobot());
            robots.add(new FDMFightRobot());
            robots.add(new UnverseFightRobot());
            robots.add(new SYCFightRobot());
            robots.add(new DeadShotA());
            robots.add(new MrMuscleRobot());
